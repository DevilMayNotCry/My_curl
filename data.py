        ...
        while True:
            ...
            if (self.is_inference) or (self.is_valid):
                ...
                input_img = util.ImageProcessing.load_image(
                    os.path.join('/content/drive/MyDrive/curl/curl/train/A', self.data_dict[idx]), normaliser=self.normaliser)
                output_img = util.ImageProcessing.load_image(
                    os.path.join('/content/drive/MyDrive/curl/curl/train/B', self.data_dict[idx]), normaliser=self.normaliser)
...
class Adobe5kDataLoader(DataLoader):
    ...
    def load_data(self):
        ...
        self.data_dict = self.img_ids_filepath
